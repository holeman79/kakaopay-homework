package com.kakaopay.homework.internetbanking.exception.handler;
...
import com.kakaopay.homework.internetbanking.exception.ErrorResponse;
...
public class ControllerExceptionHandler {
    ...
    protected ResponseEntity<ErrorResponse> handleJwtException(JwtException e) {
        ...
        final ErrorResponse response = ErrorResponse.of(ErrorCode.ACCESS_TOKEN_EXPIRED);
